...
SECRET_KEY = os.getenv("SECRET_KEY") or os.getenv("FLASK_SECRET_KEY") or JWT_SECRET
...
SESSION_COOKIE_SECURE = _env_flag("SESSION_COOKIE_SECURE", COOKIE_SECURE)
SESSION_COOKIE_SAMESITE = os.getenv("SESSION_COOKIE_SAMESITE", COOKIE_SAMESITE)
