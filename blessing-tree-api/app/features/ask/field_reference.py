...
FIELD_REFERENCES: tuple[FieldReference, ...] = (
    ...
    FieldReference(
        ...
        what_it_does='PDF and Excel controls in the upper right of directory and report containers.',
        suggestion='Apply filters, expansion, and sorting first, then export the view staff need to print or reconcile.',
    ),
    FieldReference(
        section='Common List, Drawer, and Export Controls',
        field='Expand All / Collapse All',
        what_it_does='Opens or closes all visible grouped rows in directory tables.',
        suggestion='Use Expand All before printing detailed family, organization, member, gift, and sponsor rows; use Collapse All for a compact overview.',
    ),
    FieldReference(
        section='Common List, Drawer, and Export Controls',
        field='Program Abbreviation Filters',
        what_it_does='Quick filter chips generated from program abbreviations present in the current campaign data.',
        suggestion='Use them to focus on one program such as AZ, BT, FC, HB, or OAK. New program abbreviations appear automatically when records use them.',
    ),
    FieldReference(
        section='Common List, Drawer, and Export Controls',
        field='Recipient ID Sort',
        what_it_does='Sorts person and organization rows by recipient ID or program code.',
        suggestion='Use recipient ID order when printing operating lists or matching reports to labels and gift rows.',
    ),
    FieldReference(
    ...
    FieldReference(
        ...
        suggestion='Use phrases like girls age 8 to 10 who need coats, toys for boys under 8, Batman gifts, video games, or unsponsored gifts for adults.',
    ),
    FieldReference(
        section='Gift Workflow and Gift Status Fields',
        field='Search Chips',
        what_it_does='Filters inferred from the gift search prompt.',
        suggestion='Review the chips after searching and clear any chip that narrows the results too much.',
    ),
    FieldReference(
        section='Gift Workflow and Gift Status Fields',
        field='Semantic Gift Search',
        what_it_does='Optional Qdrant-backed matching for broader gift wording and synonyms.',
        suggestion='Use it for broad searches such as toys, superheroes, or video games when the wishlist may use a specific brand or title.',
    ),
    FieldReference(
        section='Gift Workflow and Gift Status Fields',
        field='Gift Search Pagination',
        what_it_does='Page controls for moving through gift search results.',
        suggestion='Use pagination when a broad search returns more gifts than fit on one screen.',
    ),
    FieldReference(
        section='Gift Workflow and Gift Status Fields',
        field='Gift Search Export',
        what_it_does='PDF and Excel export buttons for gift search results.',
        suggestion='Use PDF for a printable result list and Excel when staff need to sort or filter outside the app.',
    ),
    FieldReference(
        section='Gift Workflow and Gift Status Fields',
        field='Sponsor Selection',
        what_it_does='Sponsor assigned to a gift commitment.',
        suggestion='Search for the sponsor, click the correct result, and confirm the selected sponsor appears below the search bar before committing.',
    ),
    FieldReference(
        section='Gift Workflow and Gift Status Fields',
        field='Selected Sponsor',
        what_it_does='Sponsor currently chosen in the commit gift drawer.',
        suggestion='Use the X to clear the selected sponsor if the wrong person was chosen, then search again.',
    ),
    FieldReference(
        section='Gift Workflow and Gift Status Fields',
        field='Commit Notes',
        what_it_does='Optional staff notes stored with the gift commitment.',
        suggestion='Use notes for sponsor-specific context, promised details, or operational reminders.',
    ),
    FieldReference(
        section='Gift Workflow and Gift Status Fields',
        field='Release Gift',
        what_it_does='Removes the sponsor from a committed gift and makes the gift available again.',
        suggestion='Read the confirmation modal carefully because it identifies the sponsor being released.',
    ),
    FieldReference(
        section='Gift Workflow and Gift Status Fields',
    ...
    FieldReference(
        section='Gift Pool Summary Fields',
        field='Inventory Lines',
        what_it_does='Counts inventory rows in the pool, not physical item quantity. One row might represent one coat or ten coats depending on the row quantity.',
        suggestion='Use this to understand how many distinct inventory entries staff have entered. If staff ask how many physical gifts are available, use Available Items instead.',
    ),
    FieldReference(
        section='Gift Pool Summary Fields',
        field='Total Items',
        what_it_does='Sums the quantity field across visible gift pool inventory rows. This is the physical donated item count represented by the current view.',
        suggestion='Use this when staff want to know how many donated items were entered into the pool before assignments are considered.',
    ),
    FieldReference(
        section='Gift Pool Summary Fields',
        field='Available Items',
        what_it_does='Sums the physical item quantity still available to assign from visible pool inventory rows.',
        suggestion='Use this as the operational count of pool items staff can still assign. This number should go down after pool inventory is assigned.',
    ),
    FieldReference(
        section='Gift Pool Summary Fields',
        field='Assigned Items',
        what_it_does='Sums the physical pool item quantity already assigned to recipient wishlist items.',
        suggestion='Use this to see how much donated inventory has already been matched. This number should go up after staff assign pool inventory.',
    ),
    FieldReference(
        section='Gift Pool Assignment Fields',
        field='Suggested Matches',
        what_it_does='Shows recommendations for the selected inventory item. Results are ranked by how well the donated item appears to fit wishlist gifts.',
        suggestion='Use Suggested Matches first when staff do not already know who should receive the item. It compares category, description, size, age, gender, and priority.',
    ),
    FieldReference(
        section='Gift Pool Assignment Fields',
        field='Needs Gifts',
        what_it_does='Shows recipients who do not currently have any gift covered. The list is ordered by family ID and recipient ID so staff can work through it predictably.',
        suggestion='Use Needs Gifts when fairness is the priority and staff want to help people who have not had a gift covered yet. Still review the gift details before assigning.',
    ),
    FieldReference(
        section='Gift Pool Assignment Fields',
        field='Search',
        what_it_does='Finds assignable wishlist items only after staff type a search term. It can search recipient ID, family ID, recipient name, gift description, category, or size.',
        suggestion='Use Search when staff already know who or what they are looking for. If staff do not know, start with Suggested Matches or Needs Gifts.',
    ),
    FieldReference(
        section='Gift Pool Assignment Fields',
        field='Remove',
        what_it_does='Removes a current pool inventory assignment from a recipient wishlist item after staff confirm the action.',
        suggestion='Use Remove when inventory was assigned to the wrong recipient or wrong wishlist item. It makes the inventory available again and reopens the recipient gift if the gift is no longer covered.',
    ),
    FieldReference(
