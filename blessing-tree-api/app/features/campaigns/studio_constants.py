...
COMMUNICATION_AUDIENCE_ALIASES = {
    ...
    "FACILITY": COMMUNICATION_AUDIENCE_ADULT_PROGRAM_CONTACT,
    "ADULT_PROGRAM": COMMUNICATION_AUDIENCE_ADULT_PROGRAM_CONTACT,
...
COMMUNICATION_AUDIENCE_CATALOG = (
    ...
    {
        "key": COMMUNICATION_AUDIENCE_ADULT_PROGRAM_CONTACT,
