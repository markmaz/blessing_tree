...
def _sample_template_merge_fields(manager_name: str) -> dict[str, str]:
    return {
        ...
        "sponsor.email": "taylor.reed@example.test",
        "sponsor.phone": "7135550198",
        "gift.commitment_count": "3",
        "gift.commitment_summary": "3 gifts for Ava Johnson and Noah Johnson",
        "gift.all_list": "Ava Johnson (BT-001): Winter coat, size Youth M\nNoah Johnson (BT-002): Lego city set\nNoah Johnson (BT-002): Art markers",
        "gift.all_table": "Ava Johnson (BT-001): Winter coat, size Youth M\nNoah Johnson (BT-002): Lego city set\nNoah Johnson (BT-002): Art markers",
        "gift.items_list": "Ava Johnson (BT-001): Winter coat, size Youth M\nNoah Johnson (BT-002): Lego city set\nNoah Johnson (BT-002): Art markers",
        "gift.items_table": "Ava Johnson (BT-001): Winter coat, size Youth M\nNoah Johnson (BT-002): Lego city set\nNoah Johnson (BT-002): Art markers",
        "gift.awaiting_turn_in_list": "Ava Johnson (BT-001): Winter coat, size Youth M\nNoah Johnson (BT-002): Lego city set",
        "gift.awaiting_turn_in_table": "Ava Johnson (BT-001): Winter coat, size Youth M\nNoah Johnson (BT-002): Lego city set",
        "gift.received_or_later_list": "Noah Johnson (BT-002): Art markers",
        "gift.received_or_later_table": "Noah Johnson (BT-002): Art markers",
        "gift.recipient_names": "Ava Johnson, Noah Johnson",
        "gift.due_date": "December 18, 2026",
        "gift.dropoff_instructions": "Bring gifts to the Blessing Tree Demo Warehouse and show this QR code at check-in.",
        "gift.dropoff_qr_url": "https://docker.blessing-tree.com/mobile/receive/dropoff/demo-token",
        "gift.dropoff_qr_image": "https://docker.blessing-tree.com/api/v1/campaigns/mobile/dropoff-qr/demo-token.png",
        "gift.dropoff_qr_image_url": "https://docker.blessing-tree.com/api/v1/campaigns/mobile/dropoff-qr/demo-token.png",
        "gift.dropoff_recipient_ids": "BT-001, BT-002",
        "gift.dropoff_recipient_summary": "BT-001 Ava Johnson; BT-002 Noah Johnson",
