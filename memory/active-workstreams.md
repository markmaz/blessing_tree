...
- Split the admin frontend into left-sidebar child sections under `Admin` so user management, LLM configuration, and health checks are no longer stacked on one screen
