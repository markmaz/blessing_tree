...
- Frontend:
  ...
  - Campaign Studio Communications now uses a template-only builder with saved-template browsing, metadata/content editing, and rendered email previewing; communication timing remains in the calendar/scheduler flow
