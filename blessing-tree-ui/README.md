...
- The communications section is now a template-only builder with a collapsible saved-template rail, metadata/content editing, rendered preview, and heading/text/image content blocks; communication timing remains in the calendar/scheduler flow.
