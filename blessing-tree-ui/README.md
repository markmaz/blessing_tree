...
- The communications section is now a template-only builder with saved-template browsing, metadata/content editing, and rendered preview; communication timing remains in the calendar/scheduler flow.
