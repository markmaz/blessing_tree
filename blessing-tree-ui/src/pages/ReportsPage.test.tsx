  ...
  it('renders people reporting for the selected campaign', () => {
    ...
    mockUseCampaignPeopleWorkspace.mockReturnValue({
      workspace: {
        ...
        recipients: [
          {
            ...
            notes: null,
            status: 'ACTIVE',
            group: { id: 'group-1', groupName: 'Jones Family', groupType: 'HOUSEHOLD', status: 'ACTIVE' },
            wishlist: {
              id: 'wishlist-1',
              campaignId: 'campaign-1',
          ...
          },
          {
            ...
            notes: null,
            status: 'ACTIVE',
            group: { id: 'group-2', groupName: 'Maple Grove', groupType: 'CARE_FACILITY', status: 'ACTIVE' },
            wishlist: {
              id: 'wishlist-2',
              campaignId: 'campaign-1',
        ...
        filters: {
          groupTypes: ['HOUSEHOLD', 'CARE_FACILITY'],
          groupStatuses: ['ACTIVE'],
          programTypes: ['CHILD_FAMILY', 'SENIOR_FACILITY'],
