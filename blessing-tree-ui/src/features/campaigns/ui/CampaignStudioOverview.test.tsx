...
const studio: CampaignStudioData = {
  ...
  giftPolicy: {
    id: 'policy-1',
    campaignId: 'campaign-1',
    maxGiftsPerSponsor: 3,
    maxWishlistItemsPerRecipient: 3,
    recipientCoverageRule: 'ALL_GIFTS_SPONSORED',
    recipientCoverageRequiredCount: 1,
    allowPartialSponsorCommitments: false,
    reservationHoldMinutes: 1440,
    createdAt: null,
    updatedAt: null,
  },
  readiness: {
